export function encrypt(key: number, plaintext: number) {
...
export function decrypt(key: number, ciphertext: number) {
...
function meetsLengthRequirement(key: number, text: number) {
...
function toBinaryString(binaryLength: number, text: number) {
